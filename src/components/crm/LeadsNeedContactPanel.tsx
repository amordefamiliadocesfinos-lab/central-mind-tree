...
export function LeadsNeedContactPanel({ contacts, onOpenContact }: LeadsNeedContactPanelProps) {
  const staleLeads = useMemo(() => {
    ...
    return contacts
      .filter(c => {
        ...
        if (!c.ultimo_contato) return true; // never contacted
        try {
      ...
      .sort((a, b) => {
        // null (never contacted) first, then by days desc
